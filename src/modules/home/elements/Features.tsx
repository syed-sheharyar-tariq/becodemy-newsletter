...
export default function Feature() {
  return (
    <div className="w-full md:flex items-center bg-[#9399F4] py-10 text-center md:text-left md:min-h-[55vh]">
      ...
      <div className="md:w-[50%]">
        ...
        <br />
        <h3 className="text-cyber-ink text-xl md:text-3xl max-w-full md:max-w-lg font-semibold text-center md:text-left">
          The most powerful editing and design tools in email.
        </h3>
        <br />
        <p className="text-cyber-ink text-xl md:text-2xl max-w-full md:max-w-lg font-[400] text-center md:text-left">
